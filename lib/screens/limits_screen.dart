...
class _LimitsScreenState extends State<LimitsScreen> {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Add a limit to get notified when you exceed it. Your partner will receive the message you set.',
                  ...
                  itemBuilder: (context, i) {
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text(
                          '${r.minutesAllowed} min in ${r.windowMinutes ~/ 60} hr · "${r.shameMessage}"',
                          maxLines: 2,
  ...
  Future<void> _addRule(BuildContext context) async {
    final result = await showDialog<LimitRule>(
      context: context,
  ...
  Future<void> _deleteRule(LimitRule rule) async {
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('Remove limit for ${rule.appDisplayName.isEmpty ? rule.appPackageOrCategory : rule.appDisplayName}?'),
        actions: [
      ...
      content: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            TextField(
              controller: _shameController,
              maxLines: 2,
              decoration: const InputDecoration(
                labelText: 'Message to partner',
                hintText: 'e.g. is doom-scrolling again.',
                border: OutlineInputBorder(),
              ),
            ),
          ],
        ...
        FilledButton(
          onPressed: () {
            final rule = LimitRule(
              appPackageOrCategory: _packageController.text.trim().isEmpty
